  ...
  return (
    <div className="overflow-y-auto sm:p-0 pt-4 pr-4 pb-20 pl-4 bg-transparent">
      <div className="flex justify-center items-end text-center min-h-screen sm:block">
        ...
        <div className="inline-block text-left bg-gray-900 rounded-lg  align-bottom transition-all transform shadow-2xl sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
